    ...
    imagemin: {                          // Task 
	    static: {                          // Target 
	      ...
	      files: {                         // Dictionary of files   // 'destination': 'source'
	        ...
	        'img/dist/projects/codr/background.jpg': 			'img/src/projects/codr/background.jpg',
	        'img/dist/projects/codr/image.png': 				'img/src/projects/codr/image.png',
	        'img/dist/projects/gist/background.jpg': 			'img/src/projects/gist/background.jpg',
	        'img/dist/projects/gist/image.png': 				'img/src/projects/gist/image.png',
	        'img/dist/projects/meta-jersey/background.jpg': 	'img/src/projects//meta-jersey/background.jpg',
	        'img/dist/projects//meta-jersey/image.png': 		'img/src/projects//meta-jersey/image.png'
	      }
    	}
    },
    watch: {
